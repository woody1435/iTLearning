...
/**
 * @author woody
 * @作用 包括标准输入，标准输出和错误输出流; 访问外部定义的属性和环境变量;
...
public final class System {
    ...
    /**
     * @作用 此方法返回以毫秒为单位，当前时间和午夜，1970年1月1日UTC(协调世界时)之间的时间差。
     * @原理 原理描述
     * @备注 备注信息
     * @author woody
     * @since 0.0.1
    ...
    /**
     * @作用 将src对象的srcPos索引位长度为length的对象复制到dest的destPos索引位
     * @原理 原理描述
     * @备注 备注信息
     * @author woody
     * @since 0.0.1
    ...
    */
    ...
    /**
     * @作用 获取指定的环境变量的值。环境变量是依赖于系统的外部命名值
     * @原理 原理描述
     * @备注 备注信息
     * @author woody
     * @since 0.0.1
    ...
    /**
     * @作用 终止当前正在运行的Java虚拟机。 参数用作状态码;按照惯例，非零的状态码表示异常终止。
     * @原理 原理描述
     * @备注 备注信息
     * @author woody
     * @since 0.0.1
